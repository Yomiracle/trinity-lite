...
def build_parser() -> argparse.ArgumentParser:
    ...
    route = sub.add_parser("route", help="resolve a route without dispatching")
    route.add_argument("task")
    route.add_argument("--type", dest="task_type")
    route.add_argument("--previous-agent")

    dispatch = sub.add_parser("dispatch", help="dispatch to an explicit agent")
    ...
    auto = sub.add_parser("dispatch-auto", help="resolve route then dispatch")
