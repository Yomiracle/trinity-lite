...
- provider API keys or endpoint URLs inside public agent examples
...
- Provider-specific API setup belongs in the CLI agent or a local wrapper, not in public config.
...
- No real API keys
- No private provider endpoint URLs
